function [b0, dt, w, w_wlls] = dki_fit(dwi, grad, mask, constraints, outliers, maxbval)
    ...
    %
    % b0 = signal at b=0
    % dt = Diffusion tensor and kurtosis tensor
    %
    %
    % Required input: 
    % ---------------
