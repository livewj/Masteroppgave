...
if length(UniqueTensorCoefficients) == 6
    tensortype = 'Diffusion tensor';
end
if length(UniqueTensorCoefficients) == 15
    tensortype = 'Kurtosis tensor';
end
...
hold on
fontsize = 22;
plot3([-2 2], [0 0], [0 0]), hold on, plot3([0 0], [-2 2], [0 0]), hold on, plot3([0 0], [0 0], [-2 2]);
xlabel('x','FontSize',fontsize)
ylabel('y','FontSize',fontsize)
zlabel('z','FontSize',fontsize)
title([tensortype], 'FontSize', fontsize)
